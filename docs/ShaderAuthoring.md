...
| `Dalashade_GIDebugMode` | Integer enum: `0` normal, `1` AO, `2` bounce, `3` night light pooling, `4` material influence, `5` sky rejection, `6` skin protection, `7` final GI influence, `8` depth-normal confidence, `9` emissive source, `10` bounce receiver, `11` adaptive limits/safety, `12` layered AO breakdown, `13` clamp pressure, `14` SSGI diffuse gather, `15` material bounce lanes, `16` sky-safe receivers, `17` emissive pooling lanes. Dalashade writes it as `0` through `17`, not as a normalized float. |
