...
| `Dalashade_MaterialWaterSpecular` | Effective water/wet/specular likelihood. |
...
| `Dalashade_MaterialWaterSpecular` | Supports coastal mist or wet-air diffusion only when wetness/fog/haze also supports it. |
