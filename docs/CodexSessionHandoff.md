...
Custom Dalashade shader support is optional and manual. `shaders/Dalashade_WeatherAtmosphere.fx` and `shaders/Dalashade_AdaptiveGrade.fx` are prototype shaders, and normal operation does not require them.
