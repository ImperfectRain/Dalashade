...
| `shaders/Dalashade_FrameData.fxh` | Internal FrameData wrapper contract. | Packages canonical material/water/safety/receiver resolves and optional NormalField data into shared structs. | Backbuffer, depth, material/water/depth/NormalField settings. | `FrameBaseData`, `FrameSurfaceData`. | `MaterialMasks.fxh`, `NormalField.fxh`. | `Dalashade_FrameDataDebug.fx`, `Dalashade_WeatherAtmosphere.fx`, future first-party migrations. | Experimental internal contract. |
