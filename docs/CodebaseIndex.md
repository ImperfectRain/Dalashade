...
| scene intent and tag diagnostics | `Dalashade/SceneIntent.cs` | `SceneIntent`, `TagStackDiagnostics`, `TagStackContribution` | Stack-aware scene intent values and tag-stack diagnostics | Yes, with build testing | Keep this conservative; do not move preset writing here. |
