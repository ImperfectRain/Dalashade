...
public class Configuration : IPluginConfiguration
{
    ...
    public bool EnableDalashadeSceneGIContactShadows { get; set; } = false;
    public float DalashadeSceneGIContactShadowStrength { get; set; } = 0.30f;
    public float DalashadeSceneGIContactShadowRadius { get; set; } = 0.62f;
    public float DalashadeSceneGIContactShadowSoftness { get; set; } = 0.55f;
    ...
    public bool EnableDalashadeScreenShadowsShaderVariables { get; set; } = false;
    public float DalashadeScreenShadowsStrength { get; set; } = 0.28f;
    public float DalashadeScreenShadowsReach { get; set; } = 0.62f;
    public float DalashadeScreenShadowsSoftness { get; set; } = 0.55f;
    public float DalashadeScreenShadowsSourceSensitivity { get; set; } = 0.52f;
    public float DalashadeScreenShadowsDalapadInfluence { get; set; } = 0.45f;
    public int DalashadeScreenShadowsDebugMode { get; set; } = 0;
    public int DalashadeScreenShadowsDebugOutputMode { get; set; } = 0;
    public float DalashadeScreenShadowsDebugOpacity { get; set; } = 0.75f;
    public float DalashadeScreenShadowsDebugBoost { get; set; } = 2.50f;
