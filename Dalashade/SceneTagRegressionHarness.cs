...
public static class SceneTagRegressionHarness
{
    ...
    private static IReadOnlyList<SceneTagRegressionCase> CreateCases()
    {
        return new[]
        {
            Create("Eastern La Noscea / Costa del Sol coastal", "Eastern La Noscea", "Clear Skies", false, false, false, false, TimeBucket.Day, PerformanceBudget.Medium, expectedBiome: "coastal", expectedWeatherTags: new[] { "clear" }, expectedMoodTags: new[] { "coastal", "seaside", "water", "specular" }, expectedSecondaryTags: new[] { "beach", "seaside", "tropical" }, expectedMaterialMinimums: Materials((MaterialIntent.WaterSpecularChannel, 0.55f), (MaterialIntent.SandDustChannel, 0.28f), (MaterialIntent.SkyCloudFogChannel, 0.25f))),
            ...
            Create("Rainy coastal city wet stone", "Limsa Lominsa", "Rain", false, false, false, false, TimeBucket.Night, PerformanceBudget.Medium, true, expectedBiome: "coastal", expectedWeatherTags: new[] { "rain" }, expectedMoodTags: new[] { "wet", "specular", "water" }, expectedSecondaryTags: new[] { "seaside", "openSkyNight", "moonlitNight", "lamplitNight", "settlementNight", "stormNight", "coastalNight" }, expectedMaterialMinimums: Materials((MaterialIntent.WaterSpecularChannel, 0.65f), (MaterialIntent.SkyCloudFogChannel, 0.18f))),
